    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center" onClick={onClose}>
            <div className="relative w-[62.13%] aspect-640/1196 md:aspect-1193/861 bg-cover bg-center bg-no-repeat 
                bg-[url('/images/popup-pc.webp')] flex flex-col items-center" onClick={(e) => e.stopPropagation()}>
                <div className="w-[56%] aspect-668/88 bg-cover bg-center bg-no-repeat 
                bg-[url('/images/popup_title.webp')] flex items-center justify-center">
                    <p className="text-center w-[80%] text-[1.8vw] inline-block text-white uppercase italic"
                        style={{
